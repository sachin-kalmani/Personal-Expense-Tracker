<%@page import="com.entity.ExpenseCategory"%>
<%@page import="com.dao.ExCatDao"%>
...
.expense .recent::-webkit-scrollbar{
	width:5px;
}
.expense .recent::-webkit-scrollbar-thumb {
  background: #42c2ff;
  border-radius:20px;
}
.main table{
...
<div class="wrapper">
	...
	<li>
	<a href="addexpense.jsp" class="active"><i class="fa-solid fa-piggy-bank"></i><span>Add Expense</span></a>
	</li>
	<li>
    ...
    ExCatDao dao1=new ExCatDao(HibernateUtil.getSessionFactory());%>
	<%List<ExpenseCategory> list2=dao1.getAllCategoryByUser(user);
	for(ExpenseCategory incat:list2)
		{%>
			...
			<div class="expense">
					...
					<%
						...
						{%>
					  	...
					  	<td><a href="editExpense.jsp?id=<%=ex.getId() %>" class="btn">Edit</a>
		  	<a href="../deleteExpense?id=<%=ex.getId() %>" class="btn">Delete</a></td>
					  	</tr>
					  	<%
					  	}
					  %>
