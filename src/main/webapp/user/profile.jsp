...
<div class="wrapper">
	...
	<li>
	<a href="profile.jsp" class="active"><i class="fa-solid fa-user"></i><span>Profile</span></a>
	</li>
	</ul>
	<ul id="logout">
	...
	<div class="login">
		<h2>Profile
		<c:if test="${not empty msg12}">
					<p class="text">${ msg12} </p>
					<c:remove var="msg1"/>
					</c:if>
	</h2>
		<form action="updateprofile.jsp?id=${loginUser.id}" method="post">
			<div class="txt">
			<input type="text" name="title" value=<%=user.getName() %>>
